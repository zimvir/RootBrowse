...
class TestRegion:
    ...
    def test_region_creation(self):
        """测试 Region 创建"""
        region = Region(xpath="/html/body/main", label="主内容")
        assert region.xpath == "/html/body/main"
...
class TestElement:
    ...
    def test_element_default_attrs(self):
        """测试 Element 默认 attrs"""
        ele = Element(tag="button", role="button", text="提交", xpath="//button")
        assert ele.attrs == {}
...
class TestRegionSummary:
    ...
    def test_region_summary_creation(self):
        ...
        summary = RegionSummary(
            ...
            text_preview=[{"tag": "a", "text": "标题", "xpath": "/html/body/a[1]"}]
        )
...
class TestElementPreview:
    ...
    def test_element_preview_creation(self):
        ...
        assert preview.xpath == "/html/body/button[1]"
